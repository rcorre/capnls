...
#[test]
fn test_start_stop() -> capnls::Result<()> {
    TestClient::new()?;
    Ok(())
}

#[test]
fn test_open() -> capnls::Result<()> {
...
#[test]
fn test_diagnostics_on_open() -> capnls::Result<()> {
    let client = TestClient::new()?;
...
#[test]
fn test_diagnostics_on_save() -> capnls::Result<()> {
...
#[test]
fn test_no_diagnostics_on_open() -> capnls::Result<()> {
    let client = TestClient::new()?;
    assert_eq!(
        client.open(base_uri())?,
        PublishDiagnosticsParams {
...
#[test]
fn test_document_symbols() -> capnls::Result<()> {
...
#[test]
fn test_workspace_symbols() -> capnls::Result<()> {
    let mut client = TestClient::new()?;
    client.open(base_uri())?;
...
#[test]
fn test_goto_import() -> capnls::Result<()> {
    let mut client = TestClient::new()?;
    client.open(base_uri())?;
...
#[test]
fn test_goto_definition_same_file() -> capnls::Result<()> {
    let mut client = TestClient::new()?;
    client.open(base_uri())?;
...
#[test]
fn test_goto_definition_same_file_nested() -> capnls::Result<()> {
    let mut client = TestClient::new()?;
    client.open(base_uri())?;
...
#[test]
fn test_goto_definition_different_file() -> capnls::Result<()> {
    let mut client = TestClient::new()?;
    client.open(base_uri())?;
...
#[test]
fn test_goto_definition_different_file_nested() -> capnls::Result<()> {
    let mut client = TestClient::new()?;
    client.open(base_uri())?;
...
#[test]
fn test_goto_definition_partially_qualified_package() -> capnls::Result<()> {
    let mut client = TestClient::new()?;
...
#[test]
fn test_message_references() -> capnls::Result<()> {
    let mut client = TestClient::new()?;
    client.open(base_uri())?;
...
#[test]
fn test_message_references_cross_package() -> capnls::Result<()> {
    let mut client = TestClient::new()?;
...
#[test]
fn test_complete_import() -> capnls::Result<()> {
    let mut client = TestClient::new()?;
    client.open(base_uri())?;
...
#[test]
fn test_complete_keyword() -> capnls::Result<()> {
    let mut client = TestClient::new()?;
    client.open(base_uri())?;
...
#[test]
fn test_complete_type_after_adding_import() -> capnls::Result<()> {
    let mut client = TestClient::new()?;
    client.open(other_uri())?;
...
#[test]
fn test_complete_type() -> capnls::Result<()> {
    let mut client = TestClient::new()?;
    client.open(base_uri())?;
...
#[test]
fn test_import_discovery() -> capnls::Result<()> {
